...
public class WorkOrder
{
    ...
    private String IGNOREDIAVAIL;

    private String WOISSWAP;

    private String BACKOUTPLAN;

    private String MBLTIMESTAMP;

    private String SUPERVISOR;

    private String ROUTE;

    private String WO_PTW_TYPE;

    private String SNECONSTRAINT;

    private String REMDUR;
    ...
    private String ACTMATCOST;

    private String OWNERGROUP;

    private String HASCHILDREN;

    private String ESTATAPPRTOOLCOST;
    ...
    private String ESTSERVCOST;

    private String REPORTDATE;

    private String LEAD;

    private String ESTATAPPRSERVCOST;
    ...
    private String PLUSCNEXTDATE;

    private String REQASSTDWNTIME;
    ...
    private String ESTATAPPRMATCOST;
    ...
    private String OPS_EQPT_FAIL_REMARKS;

    private String LAUNCHENTRYNAME;

    private String REPFACSITEID;

    private String OUTLABCOST;

    private String GENFORPOREVISION;

    private String ESTTOOLCOST;
    ...
    private String ESTATAPPROUTLABCOST;
    ...
    private String ESTATAPPRLABHRS;

    private String WORKTYPE;

    private String ONBEHALFOF;

    private String KPI_EQPT_FAIL_REMARKS;

    private String ACTLABCOST;

    private String INTF_PRIORITY;

    private String ACTOUTLABHRS;

    private String HASFOLLOWUPWORK;
    ...
    private String OUTMATCOST;

    private String NEWCHILDCLASS;

    private String CLASSSTRUCTUREID;

    private String INCTASKSINSCHED;
    ...
    private String ESTINTLABHRS;

    private String APPTREQUIRED;

    private String HISTORYFLAG;

    private String OPSEQPTFAILURE;
    ...
    private String ACTINTLABCOST;

    private String ASSETLOCPRIORITY;

    private String SUSPENDFLOW;

    private String ESTOUTLABHRS;

    private String PLUSCFREQUNIT;

    private String GLACCOUNT;

    private String ESTATAPPRINTLABCOST;

    private String REPAIRFACILITY;

    private String ACTLABHRS;

    private String COMMODITYGROUP;

    private String CINUM;

    private String PLUSCJPREVNUM;

    private String PARENT;

    private String KPIEQPTFAILURE;

    private String ASSETNUM;

    private String WOLABLNK;

    private String LASTCOPYLINKDATE;

    private String PLUSCOVERDUEDATE;

    private String FLOWCONTROLLED;

    private String ESTATAPPROUTLABHRS;

    private String ACTINTLABHRS;

    private WoClass WOCLASS;

    private String FLOWACTIONASSIST;

    private String CHANGEBY;

    private String NESTEDJPINPROCESS;

    private String PLUSCISMOBILE;

    private String REPORTEDBY;

    private String IGNORESRMAVAIL;

    private String LMS;

    private String CALCORGID;

    private String ACTSERVCOST;

    private String REASONFORCHANGE;

    private String ESTINTLABCOST;

    private Status STATUS;

    private String ESTOUTLABCOST;

    private String AOS;

    private String DOWNTIME;

    private String PLUSCLOOP;

    private String ACTSTART;

    private String ESTLABHRS;

    private String AVAILSTATUSDATE;

    private String SITEID;

    private String ISTASK;

    private String ACTTOOLCOST;

    private String COMMODITY;

    private String CHANGEDATE;

    private String ESTATAPPRLABCOST;

    private String PARENTCHGSSTATUS;

    private String ESTATAPPRINTLABHRS;
    ...
    private String PLUSCFREQUENCY;

    private String OUTTOOLCOST;
    ...
    private String GENFORPOLINEID;

    private String CHAINAGE1;

    private String CHAINAGE2;

    private String TASKID;

    private String INTERRUPTIBLE;

    private String WOACCEPTSCHARGES;

    private String ESTDUR;

    private String PMNEXTDUEDATE;
    ...
    public String getMBLTIMESTAMP ()
    {
        return MBLTIMESTAMP;
    }

    public void setMBLTIMESTAMP (String MBLTIMESTAMP)
    {
        this.MBLTIMESTAMP = MBLTIMESTAMP;
    }
    ...
    public String getWO_PTW_TYPE ()
    {
        return WO_PTW_TYPE;
    }

    public void setWO_PTW_TYPE (String WO_PTW_TYPE)
    {
        this.WO_PTW_TYPE = WO_PTW_TYPE;
    }
    ...
    public String getREQASSTDWNTIME ()
    {
        return REQASSTDWNTIME;
    }

    public void setREQASSTDWNTIME (String REQASSTDWNTIME)
    {
    ...
    public String getOPS_EQPT_FAIL_REMARKS ()
    {
        return OPS_EQPT_FAIL_REMARKS;
    }

    public void setOPS_EQPT_FAIL_REMARKS (String OPS_EQPT_FAIL_REMARKS)
    {
        this.OPS_EQPT_FAIL_REMARKS = OPS_EQPT_FAIL_REMARKS;
    }
    ...
    public String getKPI_EQPT_FAIL_REMARKS ()
    {
        return KPI_EQPT_FAIL_REMARKS;
    }

    public void setKPI_EQPT_FAIL_REMARKS (String KPI_EQPT_FAIL_REMARKS)
    {
        this.KPI_EQPT_FAIL_REMARKS = KPI_EQPT_FAIL_REMARKS;
    }
    ...
    public String getINTF_PRIORITY ()
    {
        return INTF_PRIORITY;
    }

    public void setINTF_PRIORITY (String INTF_PRIORITY)
    {
        this.INTF_PRIORITY = INTF_PRIORITY;
    }
    ...
    public String getOPSEQPTFAILURE ()
    {
        return OPSEQPTFAILURE;
    }

    public void setOPSEQPTFAILURE (String OPSEQPTFAILURE)
    {
        this.OPSEQPTFAILURE = OPSEQPTFAILURE;
    }
    ...
    public String getKPIEQPTFAILURE ()
    {
        return KPIEQPTFAILURE;
    }

    public void setKPIEQPTFAILURE (String KPIEQPTFAILURE)
    {
        this.KPIEQPTFAILURE = KPIEQPTFAILURE;
    }
    ...
    public WoClass getWOCLASS ()
    {
        return WOCLASS;
    }

    public void setWOCLASS (WoClass WOCLASS)
    {
    ...
    public String getNESTEDJPINPROCESS ()
    {
        return NESTEDJPINPROCESS;
    }

    public void setNESTEDJPINPROCESS (String NESTEDJPINPROCESS)
    {
    ...
    public String getCHAINAGE1 ()
    {
        return CHAINAGE1;
    }

    public void setCHAINAGE1 (String CHAINAGE1)
    {
        this.CHAINAGE1 = CHAINAGE1;
    }

    public String getCHAINAGE2 ()
    {
        return CHAINAGE2;
    }

    public void setCHAINAGE2 (String CHAINAGE2)
    {
        this.CHAINAGE2 = CHAINAGE2;
    }
    ...
    {
        return "ClassPojo [ASSIGNEDOWNERGROUP = "+ASSIGNEDOWNERGROUP+", TARGETDESC = "+TARGETDESC+", IGNOREDIAVAIL = "+IGNOREDIAVAIL+", WOISSWAP = "+WOISSWAP+", BACKOUTPLAN = "+BACKOUTPLAN+", MBLTIMESTAMP = "+MBLTIMESTAMP+", SUPERVISOR = "+SUPERVISOR+", ROUTE = "+ROUTE+", WO_PTW_TYPE = "+WO_PTW_TYPE+", SNECONSTRAINT = "+SNECONSTRAINT+", REMDUR = "+REMDUR+", ORIGRECORDID = "+ORIGRECORDID+", WORKPACKMTLSTATUS = "+WORKPACKMTLSTATUS+", ORGID = "+ORGID+", ACTMATCOST = "+ACTMATCOST+", OWNERGROUP = "+OWNERGROUP+", HASCHILDREN = "+HASCHILDREN+", ESTATAPPRTOOLCOST = "+ESTATAPPRTOOLCOST+", FAILURECODE = "+FAILURECODE+", TARGSTARTDATE = "+TARGSTARTDATE+", WOGROUP = "+WOGROUP+", ESTSERVCOST = "+ESTSERVCOST+", REPORTDATE = "+REPORTDATE+", LEAD = "+LEAD+", ESTATAPPRSERVCOST = "+ESTATAPPRSERVCOST+", FLOWACTION = "+FLOWACTION+", LOS = "+LOS+", INSPECTOR = "+INSPECTOR+", PLUSCNEXTDATE = "+PLUSCNEXTDATE+", REQASSTDWNTIME = "+REQASSTDWNTIME+", DESCRIPTION = "+DESCRIPTION+", PROBLEMCODE = "+PROBLEMCODE+", AMCREW = "+AMCREW+", PMEXTDATE = "+PMEXTDATE+", WHOMISCHANGEFOR = "+WHOMISCHANGEFOR+", FAILDATE = "+FAILDATE+", ACTFINISH = "+ACTFINISH+", ACTOUTLABCOST = "+ACTOUTLABCOST+", JPNUM = "+JPNUM+", ESTMATCOST = "+ESTMATCOST+", CREWID = "+CREWID+", FNLCONSTRAINT = "+FNLCONSTRAINT+", CONTRACT = "+CONTRACT+", ESTATAPPRMATCOST = "+ESTATAPPRMATCOST+", PMNUM = "+PMNUM+", WONUM = "+WONUM+", WOSEQUENCE = "+WOSEQUENCE+", WORKORDERID = "+WORKORDERID+", OPS_EQPT_FAIL_REMARKS = "+OPS_EQPT_FAIL_REMARKS+", LAUNCHENTRYNAME = "+LAUNCHENTRYNAME+", REPFACSITEID = "+REPFACSITEID+", OUTLABCOST = "+OUTLABCOST+", GENFORPOREVISION = "+GENFORPOREVISION+", ESTTOOLCOST = "+ESTTOOLCOST+", WOPRIORITY = "+WOPRIORITY+", TARGCOMPDATE = "+TARGCOMPDATE+", DIRISSUEMTLSTATUS = "+DIRISSUEMTLSTATUS+", ESTATAPPROUTLABCOST = "+ESTATAPPROUTLABCOST+", WORKLOCATION = "+WORKLOCATION+", CHARGESTORE = "+CHARGESTORE+", PHONE = "+PHONE+", POINTNUM = "+POINTNUM+", ESTATAPPRLABHRS = "+ESTATAPPRLABHRS+", WORKTYPE = "+WORKTYPE+", ONBEHALFOF = "+ONBEHALFOF+", KPI_EQPT_FAIL_REMARKS = "+KPI_EQPT_FAIL_REMARKS+", ACTLABCOST = "+ACTLABCOST+", INTF_PRIORITY = "+INTF_PRIORITY+", ACTOUTLABHRS = "+ACTOUTLABHRS+", HASFOLLOWUPWORK = "+HASFOLLOWUPWORK+", JOBTASKID = "+JOBTASKID+", CREWWORKGROUP = "+CREWWORKGROUP+", MEASUREDATE = "+MEASUREDATE+", PERSONGROUP = "+PERSONGROUP+", RISK = "+RISK+", SCHEDFINISH = "+SCHEDFINISH+", OUTMATCOST = "+OUTMATCOST+", NEWCHILDCLASS = "+NEWCHILDCLASS+", CLASSSTRUCTUREID = "+CLASSSTRUCTUREID+", INCTASKSINSCHED = "+INCTASKSINSCHED+", JUSTIFYPRIORITY = "+JUSTIFYPRIORITY+", CALCCALENDAR = "+CALCCALENDAR+", CALCSHIFT = "+CALCSHIFT+", VERIFICATION = "+VERIFICATION+", OBSERVATION = "+OBSERVATION+", LOCATION = "+LOCATION+", SCHEDSTART = "+SCHEDSTART+", ESTINTLABHRS = "+ESTINTLABHRS+", APPTREQUIRED = "+APPTREQUIRED+", HISTORYFLAG = "+HISTORYFLAG+", OPSEQPTFAILURE = "+OPSEQPTFAILURE+", VENDOR = "+VENDOR+", STATUSDATE = "+STATUSDATE+", PLUSCPHYLOC = "+PLUSCPHYLOC+", ESTLABCOST = "+ESTLABCOST+", GENERATEDFORPO = "+GENERATEDFORPO+", AMS = "+AMS+", DISABLED = "+DISABLED+", OWNER = "+OWNER+", MEASUREMENTVALUE = "+MEASUREMENTVALUE+", STOREROOMMTLSTATUS = "+STOREROOMMTLSTATUS+", ACTINTLABCOST = "+ACTINTLABCOST+", ASSETLOCPRIORITY = "+ASSETLOCPRIORITY+", SUSPENDFLOW = "+SUSPENDFLOW+", ESTOUTLABHRS = "+ESTOUTLABHRS+", PLUSCFREQUNIT = "+PLUSCFREQUNIT+", GLACCOUNT = "+GLACCOUNT+", ESTATAPPRINTLABCOST = "+ESTATAPPRINTLABCOST+", REPAIRFACILITY = "+REPAIRFACILITY+", ACTLABHRS = "+ACTLABHRS+", COMMODITYGROUP = "+COMMODITYGROUP+", CINUM = "+CINUM+", PLUSCJPREVNUM = "+PLUSCJPREVNUM+", PARENT = "+PARENT+", KPIEQPTFAILURE = "+KPIEQPTFAILURE+", ASSETNUM = "+ASSETNUM+", WOLABLNK = "+WOLABLNK+", LASTCOPYLINKDATE = "+LASTCOPYLINKDATE+", PLUSCOVERDUEDATE = "+PLUSCOVERDUEDATE+", FLOWCONTROLLED = "+FLOWCONTROLLED+", ESTATAPPROUTLABHRS = "+ESTATAPPROUTLABHRS+", ACTINTLABHRS = "+ACTINTLABHRS+", WOCLASS = "+WOCLASS+", FLOWACTIONASSIST = "+FLOWACTIONASSIST+", CHANGEBY = "+CHANGEBY+", NESTEDJPINPROCESS = "+NESTEDJPINPROCESS+", PLUSCISMOBILE = "+PLUSCISMOBILE+", REPORTEDBY = "+REPORTEDBY+", IGNORESRMAVAIL = "+IGNORESRMAVAIL+", LMS = "+LMS+", CALCORGID = "+CALCORGID+", ACTSERVCOST = "+ACTSERVCOST+", REASONFORCHANGE = "+REASONFORCHANGE+", ESTINTLABCOST = "+ESTINTLABCOST+", STATUS = "+STATUS+", ESTOUTLABCOST = "+ESTOUTLABCOST+", AOS = "+AOS+", DOWNTIME = "+DOWNTIME+", PLUSCLOOP = "+PLUSCLOOP+", ACTSTART = "+ACTSTART+", ESTLABHRS = "+ESTLABHRS+", AVAILSTATUSDATE = "+AVAILSTATUSDATE+", SITEID = "+SITEID+", ISTASK = "+ISTASK+", ACTTOOLCOST = "+ACTTOOLCOST+", COMMODITY = "+COMMODITY+", CHANGEDATE = "+CHANGEDATE+", ESTATAPPRLABCOST = "+ESTATAPPRLABCOST+", PARENTCHGSSTATUS = "+PARENTCHGSSTATUS+", ESTATAPPRINTLABHRS = "+ESTATAPPRINTLABHRS+", PMDUEDATE = "+PMDUEDATE+", RESPONDBY = "+RESPONDBY+", CALCPRIORITY = "+CALCPRIORITY+", PLUSCFREQUENCY = "+PLUSCFREQUENCY+", OUTTOOLCOST = "+OUTTOOLCOST+", PERMITNUM = "+PERMITNUM+", FIRSTAPPRSTATUS = "+FIRSTAPPRSTATUS+", ORIGRECORDCLASS = "+ORIGRECORDCLASS+", CALENDAR = "+CALENDAR+", GENFORPOLINEID = "+GENFORPOLINEID+", CHAINAGE1 = "+CHAINAGE1+", CHAINAGE2 = "+CHAINAGE2+", TASKID = "+TASKID+", INTERRUPTIBLE = "+INTERRUPTIBLE+", WOACCEPTSCHARGES = "+WOACCEPTSCHARGES+", ESTDUR = "+ESTDUR+", PMNEXTDUEDATE = "+PMNEXTDUEDATE+", ENVIRONMENT = "+ENVIRONMENT+", ROUTESTOPID = "+ROUTESTOPID+"]";
    }
}
